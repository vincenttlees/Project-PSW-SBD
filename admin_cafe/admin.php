  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav>
      ...
      <a onclick="UI.page('category')" data-page="category">
        <span class="nav-icon">🏷️</span> Category
      </a>
  ...
  <div class="main">
    ...
    <section id="dashboard" class="page active">
      ...
      <div class="dash-grid">
        ...
        <div class="card">
          <h3>Location</h3>
          <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3989.0529342217023!2d104.0018282749654!3d1.1222982988669494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMcKwMDcnMjAuMyJOIDEwNMKwMDAnMTUuOSJF!5e0!3m2!1sen!2sid!4v1779804779308!5m2!1sen!2sid" allowfullscreen></iframe>
        </div>
      </div>
    </section>
    ...
    <section id="menu" class="page">
      <div class="page-header">
        ...
        <div class="page-header-right">
          <input id="menuSearch" placeholder="🔍 Search..." oninput="MenuUI.search(this.value)">
          <button class="btn-primary" onclick="MenuUI.openModal()">+ Add Menu</button>
        </div>
      </div>
      <div id="menuGrid" class="menu-grid-cards"></div>
    </section>
